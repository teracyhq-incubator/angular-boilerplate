# angular-boilerplate [![Build Status](https://travis-ci.org/teracyhq-incubator/angular-boilerplate.svg?branch=develop)](https://travis-ci.org/teracyhq-incubator/angular-boilerplate)
